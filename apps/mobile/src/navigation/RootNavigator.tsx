...
import SafeTripScreen from '../screens/SafeTripScreen';
      ...
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        {isAuthenticated ? (
          <>
            ...
            <Stack.Screen name="SafeTrip" component={SafeTripScreen} options={{ headerShown: true, headerTitle: 'Safe Trip', headerTintColor: '#0F7B6C' }} />
